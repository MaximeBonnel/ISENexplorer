...
declare namespace constants {
  export {
    constants_DEFAULT_TRANSITION as DEFAULT_TRANSITION,
    constants_ANIMATION_MIN_DURATION as ANIMATION_MIN_DURATION,
    constants_MOVE_THRESHOLD as MOVE_THRESHOLD,
    constants_DBLCLICK_DELAY as DBLCLICK_DELAY,
    constants_LONGTOUCH_DELAY as LONGTOUCH_DELAY,
    constants_TWOFINGERSOVERLAY_DELAY as TWOFINGERSOVERLAY_DELAY,
    constants_CTRLZOOM_TIMEOUT as CTRLZOOM_TIMEOUT,
    constants_INERTIA_WINDOW as INERTIA_WINDOW,
    constants_SPHERE_RADIUS as SPHERE_RADIUS,
    constants_VIEWER_DATA as VIEWER_DATA,
    constants_ACTIONS as ACTIONS,
    constants_KEY_CODES as KEY_CODES,
...
declare class TypedEventTarget<TEvents extends TypedEvent<any>> extends EventTarget {
    ...
    addEventListener<T extends TEvents['type'], E extends TEvents & {
        type: T;
    }>(type: T, callback: ((e: E) => void) | EventListenerObject, options?: AddEventListenerOptions | boolean): void;
    /**
     * @template T the name of event
     * @template E the class of the event
     */
    removeEventListener<T extends TEvents['type'], E extends TEvents & {
        type: T;
    }>(type: TEvents['type'], callback: ((e: E) => void) | EventListenerObject, options?: EventListenerOptions | boolean): void;
}
...
declare class PositionUpdatedEvent extends ViewerEvent {
    readonly position: PositionCompat;
...
declare namespace events {
  export {
    events_ViewerEvent as ViewerEvent,
    events_BeforeAnimateEvent as BeforeAnimateEvent,
    events_BeforeRenderEvent as BeforeRenderEvent,
    events_BeforeRotateEvent as BeforeRotateEvent,
    events_ClickEvent as ClickEvent,
    events_ConfigChangedEvent as ConfigChangedEvent,
    events_DoubleClickEvent as DoubleClickEvent,
    events_FullscreenEvent as FullscreenEvent,
    ...
    events_PositionUpdatedEvent as PositionUpdatedEvent,
    events_ReadyEvent as ReadyEvent,
    events_RenderEvent as RenderEvent,
    ...
    events_ObjectEvent as ObjectEvent,
    events_ObjectEnterEvent as ObjectEnterEvent,
    events_ObjectLeaveEvent as ObjectLeaveEvent,
    events_ObjectHoverEvent as ObjectHoverEvent,
    events_ViewerEvents as ViewerEvents,
  };
}
...
declare class Renderer extends AbstractService {
     ...
     */
    setCustomRenderer(factory: (renderer: WebGLRenderer) => Renderer$1): void;
    /**
...
declare class Viewer extends TypedEventTarget<ViewerEvents> {
    ...
    readonly tooltip: {
        /** @deprecated */
        create: (config: TooltipConfig) => Tooltip;
    };
 ...
 */
declare abstract class AbstractAdapter<TPanorama, TTexture> {
    protected readonly viewer: Viewer;
    /**
     ...
     */
    abstract loadTexture(panorama: TPanorama, newPanoData?: PanoData | PanoDataProvider, useXmpPanoData?: boolean): Promise<TextureData<TTexture>>;
    /**
     * Creates the mesh
     */
...
type AdapterConstructor = (new (viewer: Viewer, config?: any) => AbstractAdapter<any, any>);

/**
 * A wrapper around a Promise with an initial value before resolution
 */
type InitialPromise<T> = {
    initial: T;
    promise: Promise<T>;
};
/**
 ...
 */
type TextureData<T = Texture | Texture[] | Record<string, Texture>> = {
    texture: T;
    panoData?: PanoData;
    panorama: any;
};
...
type DeprecatedViewerConfig = 'defaultLong' | 'defaultLat' | 'autorotateDelay' | 'autorotateIdle' | 'autorotateSpeed' | 'autorotateLat' | 'autorotateZoomLvl';
/**
 * Viewer configuration after applying parsers
 */
type ParsedViewerConfig = Omit<ViewerConfig, 'adapter' | 'plugins' | 'defaultYaw' | 'defaultPitch' | 'fisheye' | 'requestHeaders' | 'navbar' | 'keyboard' | DeprecatedViewerConfig> & {
 ...
 */
type UpdatableViewerConfig = Omit<ViewerConfig, ReadonlyViewerConfig | DeprecatedViewerConfig>;
 ...
 */
declare function greatArcDistance([lon1, lat1]: [number, number], [lon2, lat2]: [number, number]): number;
 ...
 * @deprecated
 */
declare function positionCompat<T extends Position>(position: T): PositionCompat & T;
/**
 ...
 * ```
 */
declare function getConfigParser<T extends Record<string, any>, U extends T = T>(defaults: Required<U>, parsers?: ConfigParsers<T, U>): (userConfig: T) => U;
...
declare const index_positionCompat: typeof positionCompat;
...
declare namespace index {
  export {
    index_getElement as getElement,
    index_toggleClass as toggleClass,
    index_addClasses as addClasses,
    index_removeClasses as removeClasses,
    index_hasParent as hasParent,
    index_getClosest as getClosest,
    index_getPosition as getPosition,
    index_getStyle as getStyle,
    index_wrap as wrap,
    index_sum as sum,
    index_distance as distance,
    index_getShortestArc as getShortestArc,
    index_getAngle as getAngle,
    index_greatArcDistance as greatArcDistance,
    index_dasherize as dasherize,
    index_throttle as throttle,
    index_isPlainObject as isPlainObject,
    index_deepmerge as deepmerge,
    index_clone as clone,
    index_isEmpty as isEmpty,
    index_isNil as isNil,
    index_firstNonNull as firstNonNull,
    index_deepEqual as deepEqual,
    index_positionCompat as positionCompat,
    index_getAbortError as getAbortError,
    index_isAbortError as isAbortError,
    index_logWarn as logWarn,
    index_isExtendedPosition as isExtendedPosition,
    index_getXMPValue as getXMPValue,
    index_parsePoint as parsePoint,
    index_cleanCssPosition as cleanCssPosition,
    index_cssPositionIsOrdered as cssPositionIsOrdered,
    index_parseSpeed as parseSpeed,
    index_parseAngle as parseAngle,
    index_createTexture as createTexture,
    index_applyEulerInverse as applyEulerInverse,
    index_ConfigParsers as ConfigParsers,
    index_getConfigParser as getConfigParser,
    index_AnimationOptions as AnimationOptions,
    index_Animation as Animation,
    index_Dynamic as Dynamic,
    index_MultiDynamic as MultiDynamic,
    index_SliderDirection as SliderDirection,
    index_SliderUpdateData as SliderUpdateData,
 ...
 */
declare class EquirectangularAdapter extends AbstractAdapter<string, Texture> {
    static readonly id: string;
    static readonly supportsDownload: boolean;
    static readonly supportsOverlay: boolean;
    ...
    loadTexture(panorama: string, newPanoData: PanoData | PanoDataProvider, useXmpPanoData?: boolean): Promise<EquirectangularTexture>;
    /**
...
declare const SYSTEM: {
     ...
     */
    isTouchEnabled: InitialPromise<boolean>;
    /**
     * @internal
     */
...
export { AbstractAdapter, AbstractButton, AbstractComponent, AbstractPlugin, AdapterConstructor, AnimateOptions, ButtonConfig, ButtonConstructor, constants as CONSTANTS, ClickData, CssSize, DEFAULTS, DataHelper, DeprecatedViewerConfig, EquirectangularAdapter, EquirectangularAdapterConfig, ExtendedPosition, InitialPromise, Loader, Navbar, NavbarCustomButton, Notification, NotificationConfig, Overlay, OverlayConfig, PSVError, Panel, PanelConfig, PanoData, PanoDataProvider, PanoramaOptions, PanoramaPosition, ParsedViewerConfig, PluginConstructor, Point, Position, PositionCompat, ReadonlyViewerConfig, Renderer, SYSTEM, Size, SphereCorrection, SphericalPosition, TextureData, TextureLoader, Tooltip, TooltipConfig, TooltipPosition, TypedEvent, TypedEventTarget, UpdatableViewerConfig, Viewer, ViewerConfig, ViewerState, events, registerButton, index as utils };
