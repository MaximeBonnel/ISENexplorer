...
.psv-panel {
    ...
    &-close-button {
        ...
        top: -1px;
        right: 0;
        width: $psv-panel-close-button-size;
        height: $psv-panel-close-button-size;
        ...
        &::after {
            ...
            position: absolute;
            top: 50%;
            left: $psv-panel-close-button-size * 0.125;
            width: $psv-panel-close-button-size * 0.75;
            height: 2px;
            background-color: $psv-panel-close-button-color;
            transition: $psv-panel-close-button-animate-delay ease-in-out;
