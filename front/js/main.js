...
socket.on('getImagesNames', imageNames => {
    imageNames.forEach(imageName => {
        socket.emit('getImagesInfos', imageName);
        socket.on('getImagesInfos', (infos) => {
            scenes[imageName] = {
                "autoRotate": "-1",
                "autoRotate": false,
                "showZoomCtrl": false,
...
v = pannellum.viewer('panorama', bigboi);
*/
